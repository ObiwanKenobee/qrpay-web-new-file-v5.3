    ...
    <div class="sidebar-inner">
        ...
        <div class="sidebar-menu-wrapper">
            <ul class="sidebar-menu">
                ...
                @endif
                {{-- Remittance Method --}}
                @if (admin_permission_by_name('admin.remitance.bank.deposit.index') || admin_permission_by_name('admin.remitance.cash.pickup.index') || admin_permission_by_name('admin.remitance.countries'))
                    @php
                        $current_url = URL::current();
                        $remittance_methods  = [
                    ...
                    <li class="sidebar-menu-item sidebar-dropdown @if (in_array($current_url,$remittance_methods)) active @endif">
                        ...
                        <ul class="sidebar-submenu">
                            <li class="sidebar-menu-item">
                                @if (admin_permission_by_name('admin.remitance.bank.deposit.index'))
                                ...
                                @endif
                                @if (admin_permission_by_name('admin.remitance.cash.pickup.index'))
                                ...
                                @endif
                                @if (admin_permission_by_name('admin.remitance.countries'))
