...
@section('content')
    <div class="custom-card">
        ...
        <div class="card-body">
            <form class="card-form" action="{{ setRoute('admin.setup.header.sections.faq.update',[$type,$parent->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <div id="faq-edit" class="mfp-hide large">
        <div class="modal-data">
            ...
            <div class="modal-form-data">
                <form class="modal-form" method="POST" action="{{ setRoute('admin.setup.header.sections.faq.item.update',[$type,$parent->id]) }}" enctype="multipart/form-data">
                    @csrf
